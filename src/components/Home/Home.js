...
const Home = () => {
            ...
            <div className="col-md-4 col-12 my-3 my-lg-0 ">
                <div className="card review-container  h-100">
                    <div className="card-body">
                        <cite className="card-text review">"{review.review}"</cite>
                        ...
                        <h6 className="card-title review-name mt-4">
                            <span>
                                <img className="review-image" src={review.image} alt="img" />
                            </span>
                            {review.name},</h6>

                        <p className="card-text review-date mt-3">{review.date}</p>
                    </div>
                </div>
            </div>
        )
    ...
    return (
        <div>
            ...
            <div>
                <h2 className="text-center review-heading-text">Our Satisfactions Customers Says</h2>
